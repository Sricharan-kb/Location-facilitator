...
export const Comparison = ({
  ...
  const getClusterComparisonData = () => {
    ...
    // Sort by cluster number to maintain visual identity for the user
    return comparisonData.sort((a, b) => {
      const aNum = typeof a.cluster === 'string' ? parseInt(a.cluster.replace(/\D/g, '')) || 0 : a.cluster;
      const bNum = typeof b.cluster === 'string' ? parseInt(b.cluster.replace(/\D/g, '')) || 0 : b.cluster;
      return aNum - bNum;
    });
  };
