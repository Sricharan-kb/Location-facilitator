...
export const MapComponent = React.memo(({ data, clusters, selectedCluster, onFeatureClick, scenarioData, showComparison, forceShowClusters, mapFocusPoint }: MapComponentProps) => {
  // Debug logs
